        ...
        <div className="hm-composer__voice-bar">
          <span className="hm-composer__voice-status">
            {voiceConversation.interimText
              ? <span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={{verticalAlign:'middle',marginRight:4}}><path d="M2 12h2"/><path d="M6 8v8"/><path d="M10 5v14"/><path d="M14 9v6" opacity=".7"/><path d="M18 7v10" opacity=".5"/><path d="M22 11v2" opacity=".3"/></svg>{voiceConversation.interimText}</span>
